...
public class Item extends TaobaoObject
{
    ...
    private static final long serialVersionUID = 3848458382114217965L;
    ...
    public void setDeliveryTimeString(String deliveryTime)
    {
        this.deliveryTime = deliveryTime;
    }
    ...
    public void setItemRectangleImgs(List<ItemImg> itemRectangleImgs)
    {
